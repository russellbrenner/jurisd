 ...
 * (www or classic).
 */
export function isAustliiUrl(url) {
    try {
 ...
 */
export function toClassicUrl(url) {
    try {
        const parsed = new URL(url);
 ...
 * // => "https://www.austlii.edu.au/au/cases/cth/HCA/1992/23.html"
 */
export function normaliseAustliiPath(urlOrPath) {
 ...
 * // => "https://classic.austlii.edu.au/au/cases/cth/HCA/1992/23.html"
 */
export function toClassicDocUrl(url) {
    try {
        const parsed = new URL(url);
 ...
 */
export function austliiUrlToNeutralCitation(url) {
    let pathname;
    try {
    ...
    if (!(court in COURT_TO_AUSTLII_PATH))
        return null;
 ...
 */
export function austliiUrlIsLegislation(url) {
    try {
...
//# sourceMappingURL=austlii-url.js.map